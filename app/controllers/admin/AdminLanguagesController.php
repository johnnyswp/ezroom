...
class AdminLanguagesController extends \BaseController {
	...
	public function store()
	{
        ...
        if ($validation->fails())
        {
            ...
            $lang->txt_informacion_de_servicio = Input::get('txt_informacion_de_servicio');
            $lang->txt_programa_de_actividades = Input::get('txt_programa_de_actividades');
            $lang->txt_de_servicios_de_habitaciones = Input::get('txt_de_servicios_de_habitaciones');
            $lang->txt_informacion_de_alrededores = Input::get('txt_informacion_de_alrededores');
            $lang->txt_ver_productos = Input::get('txt_ver_productos');
            $lang->txt_no_hay_actividades = Input::get('txt_no_hay_actividades');
            $lang->txt_pedido_realizados = Input::get('txt_pedido_realizados');
            if($lang->save()){
                if(Input::file('flag')!=NULL)
                {
