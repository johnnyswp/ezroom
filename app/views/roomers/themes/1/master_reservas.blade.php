...
<head>
	...
	<link type="text/css" rel="stylesheet" href="{{ asset('roomers/css/theme_service.css') }}"  media="all"/>
	...
	<link type="text/css" rel="stylesheet" href="/assets/plugins/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css" />
...
<body class="">
	...
	<script  type="text/javascript" charset="utf-8">
		...
		var $input =  $('#fecha_reserva').pickadate({
			min: true,
			//max: {{$max}},
            	...
            	var today = moment().format('L');
                    ...
                    var timer = $time.pickatime('picker');
                    	var date = picker.get('select', 'mm/dd/yyyy');
                    	  $.post(shopcar.url+'/roomer/stay-date-max', 
                    	  {
                    	  	stay_id: '{{$stay->id}}', 
                    	  	'date':date
                    	  }, 
